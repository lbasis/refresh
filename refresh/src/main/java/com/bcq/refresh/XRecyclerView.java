...
import com.bcq.refresh.xrecycle.AppBarStateChangeListener;
import com.bcq.refresh.xrecycle.ArrowRefreshHeader;
import com.bcq.refresh.xrecycle.CustomFooterViewCallBack;
import com.bcq.refresh.xrecycle.LoadingMoreFooter;
...
import static com.bcq.refresh.xrecycle.BaseRefreshHeader.STATE_DONE;
...
public class XRecyclerView extends RecyclerView implements IRefresh {
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadListener != null && !isLoadingData && loadingMoreEnabled) {
